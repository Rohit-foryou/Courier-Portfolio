          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-4 text-gray-600">
                Secure and time-sensitive delivery of important documents such
                as agreements, legal papers, invoices, and confidential records.
                We coordinate with reliable courier partners to ensure safe
                handling and on-time delivery.
              </p>
            </div>
            <div className="bg-blue-50/50 rounded-2xl p-6 flex justify-center">
  <Image
  src="/images/services-hero.png"
  alt="Courier and logistics services"
  width={360}
  height={260}
  className="object-contain"
  priority
/>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 flex justify-center">
              <Image
                src="/images/Intercity.png"
                alt="Local and intercity deliveries"
                width={360}
                height={260}
              />
            </div>
            <div className="order-1 md:order-2">
              ...
              <p className="mt-4 text-gray-600">
                We manage local and intercity deliveries with a strong focus on
                last-mile efficiency. From same-city shipments to intercity
                logistics, we ensure smooth coordination and reliable timelines.
              </p>
            </div>
          </div>
          {/* Service 5 */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-4 text-gray-600">
                ...
                coordination. We help enterprises manage regular courier
                requirements with dependable partners, clear communication, and
            ...
            <div className="flex justify-center">
              <Image
                src="/images/Parcel.png"
                alt="Business and corporate logistics"
                width={360}
                height={260}
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 flex justify-center">
              <Image
                ...
                alt="Multi courier optimization"
                width={360}
                height={260}
              />
            </div>
            <div className="order-1 md:order-2">
              ...
              <p className="mt-4 text-gray-600">
                We intelligently select the most suitable courier partner for
                every shipment based on destination, delivery urgency, and cost
                — ensuring optimal performance for each delivery.
              </p>
            </div>
          </div>
        </div>
