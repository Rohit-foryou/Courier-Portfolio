      ...
      <div className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="mt-6 text-lg text-gray-600 max-w-xl">
            ...
            helping lawyers, banks, businesses, and individuals save time with
            professional assistance and PAN India reach.
          </p>
          ...
          <p className="mt-6 text-sm text-gray-500">
            Trusted Post Office Franchise serving Legal Firms, Banks & Businesses across Delhi NCR
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <Image
            ...
            alt="India Post mailing and post office franchise services illustration"
            width={420}
            height={320}
