...
export default function PartnersPage() {
  const partners = [
    { name: "India Post", logo: "/images/partners/indiapost.png" },
    { name: "Private Courier Partners", logo: "/images/partners/courier.png" },
    { name: "Regional Logistics Providers", logo: "/images/partners/regional.png" },
    { name: "Last-Mile Delivery Networks", logo: "/images/partners/lastmile.png" },
  ];
